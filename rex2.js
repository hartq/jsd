async function sendRequests() {
    try {
        ...
        await fetch('https://h1s.freshservice.com/itil/requesters/59001933202/make_agent', {
            method: 'POST',
            credentials: 'include',
            headers: {
        ...
        await fetch('https://h1s.freshservice.com/api/_/agents/59001933202/map_workspace_groups_and_roles', {
            method: 'PUT',
            credentials: 'include',
            headers: {
